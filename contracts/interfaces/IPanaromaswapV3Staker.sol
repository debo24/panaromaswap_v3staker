...
import 'panaromaswap_v3periphery/contracts/interfaces/IMulticall.sol';

/// @title Panaromaswap V3 Staker Interface
/// @notice Allows staking nonfungible liquidity tokens in exchange for reward tokens
interface IPanaromaswapV3Staker is IERC721Receiver, IMulticall {
    /// @param rewardToken The token being distributed as a reward
    /// @param pool The Panaromaswap V3 pool
    ...
    /// @notice The Panaromaswap V3 Factory
    function factory() external view returns (IPanaromaswapV3Factory);
    ...
    /// @notice Withdraws a Panaromaswap V3 LP token `tokenId` from this contract to the recipient `to`
    ...
    /// @notice Stakes a Panaromaswap V3 LP token
    /// @param key The key of the incentive for which to stake the NFT
    /// @param tokenId The ID of the token to stake
    function stakeToken(IncentiveKey memory key, uint256 tokenId) external;

    /// @notice Unstakes a Panaromaswap V3 LP token
    ...
    event IncentiveCreated(
        ...
        IPanaromaswapV3Pool indexed pool,
        uint256 startTime,
        uint256 endTime,
        address refundee,
        uint256 reward
    ...
    /// @notice Event emitted when a Panaromaswap V3 LP token has been staked
    /// @param tokenId The unique identifier of an Panaromaswap V3 LP token
    /// @param liquidity The amount of liquidity staked
    /// @param incentiveId The incentive in which the token is staking
    event TokenStaked(uint256 indexed tokenId, bytes32 indexed incentiveId, uint128 liquidity);

    /// @notice Event emitted when a Panaromaswap V3 LP token has been unstaked
    /// @param tokenId The unique identifier of an Panaromaswap V3 LP token
    /// @param incentiveId The incentive in which the token is staking
