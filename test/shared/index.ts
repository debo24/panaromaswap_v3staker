...
import { IPanaromaswapV3Pool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: IPanaromaswapV3Pool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: IPanaromaswapV3Pool): Promise<number> => (await getSlot0(pool)).tick
