...
interface ISwapRouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    'panaromaswapV3SwapCallback(int256,int256,bytes)': FunctionFragment
  }
  ...
  encodeFunctionData(functionFragment: 'panaromaswapV3SwapCallback', values: [BigNumberish, BigNumberish, BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'panaromaswapV3SwapCallback', data: BytesLike): Result
...
export class ISwapRouter extends Contract {
  ...
  functions: {
    ...
    'panaromaswapV3SwapCallback(int256,int256,bytes)'(
      amount0Delta: BigNumberish,
      amount1Delta: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
